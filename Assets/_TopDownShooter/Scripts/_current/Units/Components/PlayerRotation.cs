...
namespace _current.Units.Components
{
    public class PlayerRotation : PawnComponent<PlayerPawn>
    {
        ...
        [SerializeField] private RectTransform _nominalCrosshairImage;
        ...
        private void AimToTarget()
        {
            ...
            _targetTransform.position =  Vector3.Lerp(_targetTransform.position,_rotationDirection,_targetMoveSpeed * Time.deltaTime);
            _nominalCrosshairImage.position = _pawn.PlayerCamera.WorldToScreenPoint(_targetTransform.position);
